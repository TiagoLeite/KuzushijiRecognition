...
def filter_detections(
    ...
    def _filter_detections(scores, labels):
        ...
        indices = keras.backend.cast(backend.where(keras.backend.greater(scores, score_threshold)),
                                     dtype='int32')
        ...
        indices = keras.backend.stack([keras.backend.cast(indices[:, 0], dtype='int32'), labels], axis=1)
    ...
    if class_specific_filter:
        ...
        for c in range(int(classification.shape[1])):
            ...
            labels = c * backend.ones((keras.backend.shape(scores)[0],), dtype='int32') # tava int64
...
class FilterDetections(keras.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        outputs = backend.map_fn(
            ...
            #dtype=[keras.backend.floatx(), keras.backend.floatx(), keras.backend.floatx()] + [o.dtype for o in other],
